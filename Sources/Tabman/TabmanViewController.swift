...
extension TabmanViewController {
    ...
    private func layoutContainers(in view: UIView) {
        ...
        if #available(iOS 11, *) {
            topConstraints.append(topBarContainer.topAnchor.constraint(equalTo: view.crs_safeAreaTopAnchor))
        } else {
        ...
        if #available(iOS 11, *) {
            bottomConstraints.append(bottomBarContainer.bottomAnchor.constraint(equalTo: view.crs_safeAreaBottomAnchor))
        } else {
